...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        return useCamera && 0 == position ? TYPE_CAMERA : TYPE_IMAGE;
    }
    ...
    public Image getFirstVisibleImage(int firstVisibleItem) {
        if (mImages != null && 0 != mImages.size()) {
            if (useCamera) {
    ...
    private boolean isFull() {
        return isSingle && mSelectImages.size() == 1
                || mMaxCount > 0 && mSelectImages.size() == mMaxCount;
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView ivImage, ivSelectIcon, ivMasking, ivGif, ivCamera;
