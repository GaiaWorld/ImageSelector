package com.iqos.imageselector;
...
import com.iqos.imageselector.adapter.ImagePagerAdapter;
import com.iqos.imageselector.entry.Image;
import com.iqos.imageselector.utils.ImageSelector;
import com.iqos.imageselector.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvIndicator.setText(String.format("1/%s", mImages.size()));
    ...
    private void initViewPager() {
        ...
        vpImage.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                tvIndicator.setText(String.format("%s/%s", (position + 1), mImages.size()));
    ...
    private void setSelectImageCount(int count) {
        if (count == 0) {
            ...
            if (isSingle) {
                ...
                tvConfirm.setText(String.format(getResources().getString(R.string.select_order), count, mMaxCount));
            } else {
                tvConfirm.setText(String.format(getResources().getString(R.string.select_count), count));
            }
        }
    }
